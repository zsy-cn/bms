...
import (
	...
	"github.com/zsy-cn/bms/service/parser/sos_yingfeichi_01"
...
func init() {
	...
	viper.SetDefault("bind-addr", ":7402")
	viper.SetDefault("service-name", "sos_model_02")
	// 注意service地址要能被consul访问到, 且端口与服务监听端口保持一致
	viper.SetDefault("service-addr", "sosyingfeichi01-serv")
	viper.SetDefault("service-port", "7402")
}
...
func main() {
	...
	parserService, err = sos_yingfeichi_01.New(logger)
	if err != nil {
